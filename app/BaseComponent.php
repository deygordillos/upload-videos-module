...
abstract class BaseComponent
{
    ...
    public function setErrorDescription(string $description): void { $this->errorDescription = $description; }
    public function getErrorDescription(): string { return $this->errorDescription; }

    // Métodos comunes de logging
    public function setLog(DayLog $log): void { $this->log = $log; }
    public function getLog(): ?DayLog { return $this->log; }
    
    public function setTx(string $tx): void { 
        $this->tx = $tx; 
        $this->db->setTx($tx);
    }
    public function getTx(): ?string { return $this->tx; }

    // Métodos comunes de empresa
    public function setIdEmpresa(int $idEmpresa): void { $this->idEmpresa = $idEmpresa; }
    public function getIdEmpresa(): ?int { return $this->idEmpresa; }
